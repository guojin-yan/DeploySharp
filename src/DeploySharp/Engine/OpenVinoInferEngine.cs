        ...
        private void AnalyzeInputNodes(ref IConfig config)
        {
            ...
            foreach (Input input in model.inputs())
            {
                ...
                else
                {
                    ...
                    {
                        config.InputShapeType = config.InputShapeType > IOShapeType.FullyDynamicShape ? config.InputShapeType : IOShapeType.FullyDynamicShape;
                    }
                }
            }
            ...
            foreach (Output output in model.outputs())
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        config.OutputShapeType = config.OutputShapeType > IOShapeType.FullyDynamicShape ? config.OutputShapeType : IOShapeType.FullyDynamicShape;
                    }
