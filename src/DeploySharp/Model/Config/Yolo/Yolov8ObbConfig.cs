...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv8 oriented bounding box models while allowing customization.
    /// Inherits all YOLO-specific configuration parameters from <see cref="YoloConfig"/>.
    /// </para>
    /// <para>
    /// 为YOLOv8旋转框检测模型预设了最优默认值，同时允许自定义配置。
    /// 从<see cref="YoloConfig"/>继承了所有YOLO特定的配置参数。
    /// </para>
    /// <example>
    /// Basic initialization:
    /// <code>
    /// var config = new Yolov8ObbConfig("yolov8s.onnx")
    /// {
    ...
    /// <code>
    /// var config = new Yolov8ObbConfig(
    ...
    public class Yolov8ObbConfig : YoloConfig
    {
        ...
        /// Path to the YOLOv8 oriented bounding box model file (.onnx/.pt)
        /// YOLOv8 旋转框检测模型模型文件路径 (.onnx/.pt)
        /// </param>
