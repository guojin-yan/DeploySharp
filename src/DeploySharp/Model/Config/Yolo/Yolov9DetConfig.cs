...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv9 detection models while allowing customization.
    /// Inherits all YOLO-specific configuration parameters from <see cref="YoloConfig"/>.
    /// </para>
    /// <para>
    /// 为YOLOv9检测模型预设了最优默认值，同时允许自定义配置。
    /// 从<see cref="YoloConfig"/>继承了所有YOLO特定的配置参数。
    /// </para>
    /// <example>
    /// Basic initialization:
    /// <code>
    /// var config = new Yolov9DetConfig("yolov9s.onnx")
    /// {
    ...
    /// <code>
    /// var config = new Yolov9DetConfig(
    ///     modelPath: "yolov9s.onnx",
    ...
    /// </example>
    /// </remarks>
    public class Yolov9DetConfig : Yolov8DetConfig
    {
        /// <summary>
        ...
        /// Path to the YOLOv9 model file (.onnx/.ir)
        /// YOLOv9模型文件路径 (.onnx/.ir)
        /// </param>
        ...
        /// 允许完全自定义的参数化构造函数
        /// </summary>
        /// <param name="modelPath">Path to the YOLOv9 model 模型路径</param>
