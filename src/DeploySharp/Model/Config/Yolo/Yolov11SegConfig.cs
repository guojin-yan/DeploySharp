...
namespace DeploySharp.Model
{
    ...
    /// <code>
    /// var config = new Yolov11DetConfig("yolov11s-seg.onnx")
    /// {
    ...
    /// </example>
    /// </remarks>
    public class Yolov11SegConfig : Yolov8SegConfig
    {
        /// <summary>
        ...
        /// 使用前需要单独设置模型路径。
        /// </remarks>
        public Yolov11SegConfig() { }
        /// <summary>
        /// Initializes a new instance with model path and reasonable defaults
        /// 使用模型路径和合理的默认值初始化新实例
        /// </summary>
        /// <param name="modelPath">
        /// Path to the YOLOv11 segmentation model (.onnx/.ir)
        /// YOLOv11分割模型路径 (.onnx/.ir)
        /// </param>
        public Yolov11SegConfig(string modelPath)
        {
            this.ModelType = ModelType.YOLOv11Seg;
