...
{
    /// <summary>
    /// Configuration class specifically designed for YOLOv26 detection models
    /// 专为YOLOv26目标检测模型设计的配置类
    /// </summary>
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv26 detection models while allowing customization.
    ...
    /// <code>
    /// var config = new Yolov26DetConfig("yolov26s-seg.onnx")
    /// {
    ...
    /// <code>
    /// var config = new Yolov26DetConfig(
    ///     modelPath: "yolov26s-seg.onnx",
    ...
    /// </example>
    /// </remarks>
    public class Yolov26SegConfig : Yolov8SegConfig
    {
        /// <summary>
        ...
        /// 使用前需要单独设置模型路径。
        /// </remarks>
        public Yolov26SegConfig() { }
        /// <summary>
        /// Initializes a new instance with model path and reasonable defaults
        /// 使用模型路径和合理的默认值初始化新实例
        /// </summary>
        /// <param name="modelPath">
        /// Path to the YOLOv26 segmentation model (.onnx/.ir)
        /// YOLOv26分割模型路径 (.onnx/.ir)
        /// </param>
        public Yolov26SegConfig(string modelPath)
        {
            this.ModelType = ModelType.YOLOv26Seg;
