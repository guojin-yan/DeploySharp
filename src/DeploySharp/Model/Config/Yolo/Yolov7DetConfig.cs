...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv7 detection models while allowing customization.
    /// Inherits all YOLO-specific configuration parameters from <see cref="YoloConfig"/>.
    /// </para>
    /// <para>
    /// 为YOLOv7检测模型预设了最优默认值，同时允许自定义配置。
    /// 从<see cref="YoloConfig"/>继承了所有YOLO特定的配置参数。
    /// </para>
    /// <example>
    /// Basic initialization:
    /// <code>
    /// var config = new Yolov7DetConfig("yolov7s.onnx")
    /// {
    ...
    /// <code>
    /// var config = new Yolov7DetConfig(
    ...
    /// </example>
    /// </remarks>
    public class Yolov7DetConfig : YoloConfig
    {
        /// <summary>
        ...
        /// </param>
        public Yolov7DetConfig(string modelPath)
        {
            this.ModelType = ModelType.YOLOv7Det;
        ...
        /// 允许完全自定义的参数化构造函数
        /// </summary>
        /// <param name="modelPath">Path to the YOLOv7 model 模型路径</param>
