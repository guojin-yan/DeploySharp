...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv8 detection models while allowing customization.
    ...
    /// <code>
    /// var config = new Yolov8DetConfig("yolov8s.onnx")
    /// {
    ...
    public class Yolov8DetConfig : YoloConfig
    {
        ...
        /// Path to the YOLOv8 model file (.onnx/.ir)
        /// YOLOv8模型文件路径 (.onnx/.ir)
        /// </param>
        public Yolov8DetConfig(string modelPath)
        {
            this.ModelType = ModelType.YOLOv8Det;
        ...
        /// 允许完全自定义的参数化构造函数
        /// </summary>
        /// <param name="modelPath">Path to the YOLOv8 model 模型路径</param>
