...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv6 detection models while allowing customization.
    /// Inherits all YOLO-specific configuration parameters from <see cref="YoloConfig"/>.
    /// </para>
    /// <para>
    /// 为YOLOv6检测模型预设了最优默认值，同时允许自定义配置。
    ...
    /// <code>
    /// var config = new Yolov6DetConfig(
    ...
    /// </example>
    /// </remarks>
    public class Yolov6DetConfig : Yolov5DetConfig
    {
        /// <summary>
        ...
        /// </param>
        public Yolov6DetConfig(string modelPath)
        {
            this.ModelType = ModelType.YOLOv6Det;
        ...
        /// 允许完全自定义的参数化构造函数
        /// </summary>
        /// <param name="modelPath">Path to the YOLOv6 model 模型路径</param>
