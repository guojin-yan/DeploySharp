...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv11 人体姿态估计模型 models while allowing customization.
    ...
    /// <code>
    /// var config = new Yolov11PoseConfig("yolov11s-pose.onnx")
    /// {
    ...
    /// <code>
    /// var config = new Yolov11PoseConfig(
    ///     modelPath: "yolov11s-pose.onnx",
