...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Presets optimal default values for YOLOv11 oriented bounding box models while allowing customization.
    /// Inherits all YOLO-specific configuration parameters from <see cref="YoloConfig"/>.
    /// </para>
    /// <para>
    /// 为YOLOv11旋转框检测模型预设了最优默认值，同时允许自定义配置。
    /// 从<see cref="YoloConfig"/>继承了所有YOLO特定的配置参数。
    /// </para>
    /// <example>
    /// Basic initialization:
    /// <code>
    /// var config = new Yolov11ObbConfig("yolov11s-obb.onnx")
    /// {
    ...
    /// <code>
    /// var config = new Yolov11ObbConfig(
    ///     modelPath: "yolov11m.onnx",
    ...
    /// </example>
    /// </remarks>
    public class Yolov11ObbConfig : Yolov8ObbConfig
    {
        /// <summary>
        ...
        /// </param>
        public Yolov11ObbConfig(string modelPath)
        {
            this.ModelType = ModelType.YOLOv11Det;
