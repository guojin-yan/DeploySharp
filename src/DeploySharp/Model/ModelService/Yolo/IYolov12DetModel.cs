...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Provides standard YOLOv12 detection pipeline including:
    /// 提供标准YOLOv12检测流程，包括：
    /// - Input preprocessing
    ///   输入预处理
    /// - Output decoding
    ...
    /// </para>
    /// <para>
    /// Inherits from base IModel interface and implements YOLOv12-specific processing
    /// 继承自基础IYolov8DetModel接口并实现YOLOv12特定处理
    /// </para>
    /// </remarks>
    public abstract class IYolov12DetModel : IYolov8DetModel
    {
        /// <summary>
        /// Initializes a new instance of YOLOv12 detector
        /// 初始化YOLOv12检测器的新实例
        /// </summary>
