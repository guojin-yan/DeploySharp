    ...
    public abstract class IIFDETRDetModel : IModel
    {
        ...
        protected override Result[] Postprocess(DataTensor dataTensor, ImageAdjustmentParam imageAdjustmentParam)
        {
            ...
            for (int i = 0; i < resultCount; i++)
            {
                ...
                //float cx = resultBoxes[s + 0] * imageAdjustmentParam.RowImgSize.Width;
                //float cy = resultBoxes[s + 1] * imageAdjustmentParam.RowImgSize.Height;
                //float w = resultBoxes[s + 2] * imageAdjustmentParam.RowImgSize.Width;
                //float h = resultBoxes[s + 3] * imageAdjustmentParam.RowImgSize.Height;
