...
namespace DeploySharp.Data
{
    public class OcrResult
    {
        ...
        public string TextContentsToString()
        {
            ...
            // 3. 添加头部信息
            sb.AppendLine($"========== OCR 文字内容识别结果 (共 {countContents} 处) ==========");
            // 4. 遍历输出
            for (int i = 0; i < countContents; i++)
            {
                ...
                if (i < countContents && TextContents[i] != null)
                {
                    ...
                    sb.Append($"  识别置信度: {content.Confidence:F2}");
        ...
        public string TextAreasToString()
        {
            ...
            // 3. 添加头部信息
            sb.AppendLine($"========== OCR 文字区域识别结果 (共 {countAreas} 处) ==========");
            // 4. 遍历输出
        ...
        public string TextOrientationsToString()
        {
            ...
            // 3. 添加头部信息
            sb.AppendLine($"========== OCR 文字方向识别结果 (共 {countOrientations} 处) ==========");
            // 4. 遍历输出
