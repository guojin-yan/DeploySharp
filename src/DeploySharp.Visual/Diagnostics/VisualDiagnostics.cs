...
namespace JYPPX.DeploySharp.Visual
{
    ...
    public static class VisualErrorCodes
    {
        ...
        /// <summary>Configured OCR geometry validation rejected a detected region. / 配置的 OCR 几何校验拒绝了检测区域。</summary>
        public const string OcrGeometryRejected = "DS-VISUAL-4104";
        /// <summary>The dictionary does not cover a nonempty required character repertoire. / 字典无法覆盖非空的需求字符范围。</summary>
        public const string OcrCharacterCoverageMissing = "DS-VISUAL-4105";
        ...
        /// <summary>Normalized OCR text exceeded its configured scalar limit. / 规范化 OCR 文本超过配置的标量长度限制。</summary>
        public const string OcrTextNormalizationLimitExceeded = "DS-VISUAL-4108";
