...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// YOLOv8 Pose extends the detection capabilities to estimate human body keypoints,
    /// enabling applications like action recognition, motion analysis, and fitness tracking.
    /// YOLOv8 Pose扩展了检测功能以估计人体关键点，支持动作识别、运动分析和健身追踪等应用。
    /// </para>
    /// <para>
    /// Key features:
    /// 主要特点：
    ...
    /// };
    /// 
    /// using (var estimator = new Yolov8PoseModel(config))
    /// {
    ...
    {
        /// <summary>
        /// Creates a new YOLOv8 pose estimation model instance.
        /// 创建新的YOLOv8姿态估计模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov8PoseConfig / 当config不是Yolov8PoseConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv8 pose estimation inference.
        /// 对图像进行预处理以进行YOLOv8姿态估计推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv8 pose estimation inference.
        /// 对批量图像进行预处理以进行YOLOv8姿态估计推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
