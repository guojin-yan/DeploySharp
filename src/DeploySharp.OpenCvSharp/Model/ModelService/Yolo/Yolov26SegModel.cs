...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// YOLOv26 Seg extends object detection to pixel-level instance segmentation,
    /// providing precise object boundaries for applications requiring detailed object shapes.
    /// YOLOv26 Seg将目标检测扩展到像素级实例分割，为需要详细目标形状的应用提供精确的目标边界。
    /// </para>
    /// <para>
    /// Key features:
    /// 主要特点：
    ...
    /// };
    /// 
    /// using (var segmentor = new Yolov26SegModel(config))
    /// {
    ...
    {
        /// <summary>
        /// Creates a new YOLOv26 segmentation model instance.
        /// 创建新的YOLOv26分割模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov26SegConfig / 当config不是Yolov26SegConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv26 segmentation inference.
        /// 对图像进行预处理以进行YOLOv26分割推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv26 segmentation inference.
        /// 对批量图像进行预处理以进行YOLOv26分割推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
