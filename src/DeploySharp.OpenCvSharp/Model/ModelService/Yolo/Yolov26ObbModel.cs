...
{
    /// <summary>
    /// YOLOv26 Oriented Bounding Box (OBB) detection model implementation.
    /// YOLOv26旋转边界框(OBB)检测模型实现。
    /// </summary>
    /// <remarks>
    /// <para>
    /// YOLOv26 OBB extends the detection capabilities to support oriented bounding boxes,
    ...
    /// YOLOv26 OBB扩展了检测功能以支持旋转边界框，这对于检测航拍或卫星图像中的
    ...
    /// };
    /// 
    /// using (var detector = new Yolov26ObbModel(config))
    /// {
    ...
    /// <seealso cref="Yolov26DetModel"/>
    public class Yolov26ObbModel : IYolov26ObbModel
    {
        /// <summary>
        /// Creates a new YOLOv26 OBB detection model instance.
        /// 创建新的YOLOv26 OBB检测模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov26ObbConfig / 当config不是Yolov26ObbConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv26 OBB detection inference.
        /// 对图像进行预处理以进行YOLOv26 OBB检测推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv26 OBB detection inference.
        /// 对批量图像进行预处理以进行YOLOv26 OBB检测推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
