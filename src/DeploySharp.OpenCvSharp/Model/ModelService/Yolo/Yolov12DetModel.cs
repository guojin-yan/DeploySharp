...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// YOLOv12 is the next-generation object detection model with architectural improvements
    /// focusing on efficiency and accuracy balance for modern deployment scenarios.
    /// YOLOv12是下一代目标检测模型，通过架构改进专注于现代部署场景的效率和准确性平衡。
    /// </para>
    /// <para>
    /// Key features:
    /// 主要特点：
    /// - Advanced feature extraction network
    ///   先进的特征提取网络
    ...
    /// <example>
    /// <code>
    /// // Create YOLOv12 detector
    /// // 创建YOLOv12检测器
    /// var config = new Yolov12DetConfig("yolov12n.onnx")
    /// {
    ...
    /// };
    /// 
    /// using (var detector = new Yolov12DetModel(config))
    /// {
    ...
    {
        /// <summary>
        /// Creates a new YOLOv12 detection model instance.
        /// 创建新的YOLOv12检测模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov12DetConfig / 当config不是Yolov12DetConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv12 detection inference.
        /// 对图像进行预处理以进行YOLOv12检测推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv12 detection inference.
        /// 对批量图像进行预处理以进行YOLOv12检测推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
