...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// YOLOv11 is the latest version in the YOLO family, featuring enhanced architecture
    /// with improved feature extraction and more efficient detection heads.
    /// YOLOv11是YOLO家族中的最新版本，具有增强的架构，改进了特征提取和更高效的检测头。
    /// </para>
    /// <para>
    /// Key features:
    /// 主要特点：
    /// - Enhanced backbone network for better feature representation
    ///   增强的骨干网络以获得更好的特征表示
    ...
    /// // 创建YOLOv11检测器
    /// var config = new Yolov11DetConfig("yolov11n.onnx")
    /// {
    ...
    /// };
    /// 
    /// using (var detector = new Yolov11DetModel(config))
    /// {
    ...
    /// <seealso cref="Yolov11SegModel"/>
    /// <seealso cref="Yolov11PoseModel"/>
    /// <seealso cref="Yolov11ObbModel"/>
    public class Yolov11DetModel : IYolov11DetModel
    {
        /// <summary>
        /// Creates a new YOLOv11 detection model instance.
        /// 创建新的YOLOv11检测模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov11DetConfig / 当config不是Yolov11DetConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv11 detection inference.
        /// 对图像进行预处理以进行YOLOv11检测推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv11 detection inference.
        /// 对批量图像进行预处理以进行YOLOv11检测推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
