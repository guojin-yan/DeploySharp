...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// YOLOv8 Seg extends object detection to pixel-level instance segmentation,
    /// providing precise object boundaries for applications requiring detailed object shapes.
    /// YOLOv8 Seg将目标检测扩展到像素级实例分割，为需要详细目标形状的应用提供精确的目标边界。
    /// </para>
    /// <para>
    /// Key features:
    /// 主要特点：
    ...
    /// };
    /// 
    /// using (var segmentor = new Yolov8SegModel(config))
    /// {
    ...
    {
        /// <summary>
        /// Creates a new YOLOv8 segmentation model instance.
        /// 创建新的YOLOv8分割模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov8SegConfig / 当config不是Yolov8SegConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv8 segmentation inference.
        /// 对图像进行预处理以进行YOLOv8分割推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv8 segmentation inference.
        /// 对批量图像进行预处理以进行YOLOv8分割推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
