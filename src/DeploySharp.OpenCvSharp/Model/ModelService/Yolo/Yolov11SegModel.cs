...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// YOLOv11 Seg extends object detection to pixel-level instance segmentation,
    /// providing precise object boundaries for applications requiring detailed object shapes.
    /// YOLOv11 Seg将目标检测扩展到像素级实例分割，为需要详细目标形状的应用提供精确的目标边界。
    /// </para>
    /// <para>
    /// Key features:
    /// 主要特点：
    ...
    ///   实时分割性能
    /// - Suitable for complex object shapes
    ///   适用于复杂目标形状
    /// </para>
    /// </remarks>
    /// <example>
    /// <code>
    /// // Create YOLOv11 segmentor
    /// // 创建YOLOv11分割器
    /// var config = new Yolov11SegConfig("yolov11n-seg.onnx")
    /// {
    ...
    /// };
    /// 
    /// using (var segmentor = new Yolov11SegModel(config))
    /// {
    ...
    /// </code>
    /// </example>
    /// <seealso cref="Yolov11SegConfig"/>
    /// <seealso cref="Yolov11DetModel"/>
    public class Yolov11SegModel : IYolov11SegModel
    {
        /// <summary>
        /// Creates a new YOLOv11 segmentation model instance.
        /// 创建新的YOLOv11分割模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov11SegConfig / 当config不是Yolov11SegConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv11 segmentation inference.
        /// 对图像进行预处理以进行YOLOv11分割推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv11 segmentation inference.
        /// 对批量图像进行预处理以进行YOLOv11分割推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
