...
{
    /// <summary>
    /// YOLOv8 Oriented Bounding Box (OBB) detection model implementation.
    /// YOLOv8旋转边界框(OBB)检测模型实现。
    /// </summary>
    /// <remarks>
    /// <para>
    /// YOLOv8 OBB extends the standard detection capabilities to support oriented bounding boxes,
    ...
    /// YOLOv8 OBB扩展了标准检测功能以支持旋转边界框，这对于检测航拍或卫星图像中的
    ...
    /// <example>
    /// <code>
    /// // Create YOLOv8 OBB detector
    /// // 创建YOLOv8 OBB检测器
    /// var config = new Yolov8ObbConfig("yolov8n-obb.onnx")
    /// {
    ...
    /// };
    /// 
    /// using (var detector = new Yolov8ObbModel(config))
    /// {
    ...
    /// </code>
    /// </example>
    /// <seealso cref="Yolov8ObbConfig"/>
    /// <seealso cref="Yolov8DetModel"/>
    public class Yolov8ObbModel : IYolov8ObbModel
    {
        /// <summary>
        /// Creates a new YOLOv8 OBB detection model instance.
        /// 创建新的YOLOv8 OBB检测模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov8ObbConfig / 当config不是Yolov8ObbConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv8 OBB detection inference.
        /// 对图像进行预处理以进行YOLOv8 OBB检测推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv8 OBB detection inference.
        /// 对批量图像进行预处理以进行YOLOv8 OBB检测推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
