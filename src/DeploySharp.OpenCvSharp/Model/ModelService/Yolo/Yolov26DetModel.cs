...
namespace DeploySharp.Model
{
    ...
    /// <remarks>
    /// <para>
    /// YOLOv26 is a specialized object detection model variant designed for specific
    /// use cases requiring enhanced detection capabilities.
    /// YOLOv26是一种专门的目标检测模型变体，专为需要增强检测能力的特定用例而设计。
    /// </para>
    /// <para>
    /// Key features:
    /// 主要特点：
    /// - Specialized detection architecture
    ///   专门的检测架构
    ...
    /// };
    /// 
    /// using (var detector = new Yolov26DetModel(config))
    /// {
    ...
    /// <seealso cref="Yolov26SegModel"/>
    /// <seealso cref="Yolov26PoseModel"/>
    /// <seealso cref="Yolov26ObbModel"/>
    public class Yolov26DetModel : IYolov26DetModel
    {
        /// <summary>
        /// Creates a new YOLOv26 detection model instance.
        /// 创建新的YOLOv26检测模型实例。
        /// </summary>
        ...
        /// <exception cref="InvalidCastException">Thrown when config is not Yolov26DetConfig / 当config不是Yolov26DetConfig时抛出</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Preprocesses image for YOLOv26 detection inference.
        /// 对图像进行预处理以进行YOLOv26检测推理。
        /// </summary>
        /// <param name="img">Input image (OpenCvSharp Mat) / 输入图像(OpenCvSharp Mat)</param>
        ...
        /// <summary>
        /// Preprocesses batch of images for YOLOv26 detection inference.
        /// 对批量图像进行预处理以进行YOLOv26检测推理。
        /// </summary>
        /// <param name="imgs">List of input images / 输入图像列表</param>
