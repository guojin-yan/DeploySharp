...
namespace DeploySharp.Model
{
    public class Yolov8PoseModel : IYolov8PoseModel
    {
        ...
        protected override DataTensor Preprocess(object img, out ImageAdjustmentParam imageAdjustmentParam)
        {
            ...
            Mat processedImage = CvDataProcessor.Resize(image, new Data.Size(config.InputSizes[0][2], config.InputSizes[0][3]), ((Yolov8PoseConfig)config).ImgResizeMode);
            ...
            imageAdjustmentParam = ImageAdjustmentParam.CreateFromImageInfo(
                ...
                ((Yolov8PoseConfig)config).ImgResizeMode);
