...
namespace DeploySharp.Model
{
    ...
    ///   航拍/卫星图像分析
    /// - Document text detection (OCR preprocessing)
    ///   文档文本检测（OCR预处理）
    ...
    /// var config = new Yolov8ObbConfig("yolov8-obb.onnx");
    /// using var model = new Yolov8ObbModel(config);
    ...
    /// {
    ///     Console.WriteLine($"Object rotated {det.Angle:F1}°");
    /// }
    /// </code>
    /// </example>
    ...
    public class Yolov8ObbModel : IYolov8ObbModel
    {
        ...
        /// 构造函数使用OBB模型配置初始化
        /// </summary>
        /// <param name="config">YOLOv8 OBB model configuration / YOLOv8 OBB模型配置</param>
        ...
        /// <remarks>
        /// Initializes the YOLOv8 OBB model with specified configuration.
        /// 使用指定配置初始化YOLOv8 OBB模型。
        /// </remarks>
