...
namespace DeploySharp.Model
{
    ...
    /// var config = new Yolov7DetConfig("yolov7.onnx");
    /// using var model = new Yolov7DetModel(config);
    ...
    public class Yolov7DetModel : IYolov7DetModel
    {
        ...
        /// 构造函数使用模型配置初始化
        /// </summary>
        /// <param name="config">YOLOv7 detection model configuration / YOLOv7检测模型配置</param>
        ...
        /// <remarks>
        /// Initializes the YOLOv7 model with specified configuration and loads the model weights.
        /// 使用指定配置初始化YOLOv7模型并加载模型权重。
        /// </remarks>
        public Yolov7DetModel(Yolov7DetConfig config) : base(config) { }

        /// <summary>
        /// Preprocesses a single image for YOLOv7 inference
        /// 为YOLOv7推理预处理单张图像
        /// </summary>
        ...
        /// <summary>
        /// Preprocesses a batch of images for YOLOv7 inference
        /// 为YOLOv7推理预处理批量图像
        /// </summary>
