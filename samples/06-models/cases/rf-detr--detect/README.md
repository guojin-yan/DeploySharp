...
```powershell
dotnet run --project samples/06-models/catalog-workflow/ModelFactoryCatalogInspection.csproj -c Release -- --model-id rf-detr/detect
```
...
~~~powershell
pwsh -NoProfile -File eng/model-catalog/Test-PublishedModelCases.ps1 -ModelId 'rf-detr/detect' -UpdateReadmes
~~~
...
- onnx.fp32: local-ort-openvino-verified; preprocessing=rfdetr-direct-resize-imagenet-v1; postprocessing=rfdetr-global-sigmoid-topk-v1
