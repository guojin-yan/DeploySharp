...
```powershell
dotnet run --project samples/06-models/catalog-workflow -- --model-id yolo/v8/detect/n
```
...
~~~powershell
pwsh -NoProfile -File eng/model-catalog/Test-PublishedModelCases.ps1 -ModelId 'yolo/v8/detect/n' -UpdateReadmes
~~~
