...
Model ID: segmentation/sam-v1-vit-b
Task: promptable-image-segmentation
Artifact variants: sam-v1-vit-b.onnx.fp32

## Complete case workflow

Catalog selection and multi-artifact prompt-segmentation package verification. The case stages are: select the immutable catalog entry, verify the ModelPack and asset identities, prepare the declared input, create the compatible backend session, decode the task result, and write an owned output.
...
~~~powershell
pwsh -NoProfile -File eng/model-catalog/Test-PublishedModelCases.ps1 -ModelId 'segmentation/sam-v1-vit-b' -UpdateReadmes
~~~
...
- sam-v1-vit-b.onnx.fp32: ort-openvino-official-predictor-pixel-compared; preprocessing=sam-v1-longest-side-bottom-right-rgb-mean-std-v1; postprocessing=sam-v1-token-quality-threshold-restore-v1
