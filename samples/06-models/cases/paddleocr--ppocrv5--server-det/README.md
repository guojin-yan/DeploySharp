...
Model ID: paddleocr/ppocrv5/server-det
Task: text-detection
...
```powershell
dotnet run --project samples/06-models/catalog-workflow/ModelFactoryCatalogInspection.csproj -c Release -- --model-id paddleocr/ppocrv5/server-det
```
...
~~~powershell
pwsh -NoProfile -File eng/model-catalog/Test-PublishedModelCases.ps1 -ModelId 'paddleocr/ppocrv5/server-det' -UpdateReadmes
~~~
