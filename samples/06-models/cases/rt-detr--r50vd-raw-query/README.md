...
Model ID: rt-detr/r50vd-raw-query
...
~~~powershell
pwsh -NoProfile -File eng/model-catalog/Test-PublishedModelCases.ps1 -ModelId 'rt-detr/r50vd-raw-query' -UpdateReadmes
~~~
...
- onnx.fp32: local-ort-openvino-real-image-field-verified; preprocessing=rtdetr-rgb-resize-div255-v2; postprocessing=rtdetr-sigmoid-global-topk-cxcywh-v1; golden=bus.jpg strict-score-0.4 result-count-5; category-score-box-order-source-coordinate parity within declared tolerance
