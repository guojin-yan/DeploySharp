...
$models = [ordered]@{
    ...
    'deimv2.onnx' = [pscustomobject]@{ Kind='deimv2'; Source=(Join-Path $ModelRoot 'DEIMv2\DEIMv2.onnx'); Url='https://github.com/guojin-yan/DeploySharp/releases/download/models-20260817.detr.2/deim-v2-detect.model.onnx'; Sha='08a6a9052c83ccd356e91f8839dfe7b2e686639b577feb7f0b7b204f7f2969cc' }
    ...
    'rtdetr-decoded-ir.xml' = [pscustomobject]@{ Kind='rtdetr-decoded-ir'; Source=(Join-Path $ModelRoot 'RT-DETR\catalog\rtdetr-decoded.xml'); Url='https://github.com/guojin-yan/DeploySharp/releases/download/models-20260817.detr.2/rt-detr-r50vd-decoded-vector-ir.model.xml'; Sha='9d49703964c07567de7f00bda85bae1760da322e2b0655bfae110f2c222c778d' }
    'rtdetr-decoded-ir.bin' = [pscustomobject]@{ Kind=$null; Source=(Join-Path $ModelRoot 'RT-DETR\catalog\rtdetr-decoded.bin'); Url='https://github.com/guojin-yan/DeploySharp/releases/download/models-20260817.detr.2/rt-detr-r50vd-decoded-vector-ir.model.bin'; Sha='c4f2ea6021314c23d691e5d6911da0804191202d049f3927cfa242f181600455' }
    'rtdetr-decoded-onnx.onnx' = [pscustomobject]@{ Kind='rtdetr-decoded-onnx'; Source=(Join-Path $ModelRoot 'RT-DETR\catalog\rtdetr-decoded.onnx'); Url='https://github.com/guojin-yan/DeploySharp/releases/download/models-20260817.detr.2/rt-detr-r50vd-decoded-vector-onnx.model.onnx'; Sha='a0477cb6cb33f431eae72438cd9a38fa80c46bca9b8d397a4ece49a9ee4353db' }
