...
def main() -> None:
    ...
    files = []
    sources = ("classification", "semantic-segmentation", "direct-pose", "direct-instance-segmentation", "direct-obb", "text-detection", "text-recognition-ctc", "anomaly-detection")
    for name in sources:
