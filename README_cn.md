...
当前 `2.0.0-alpha.1` 新增 Visual 异常检测/分割与 OCR 文本方向/自动纠正切片，包括显式四方向语义、OpenCV 单次解码旋转、原图 polygon 恢复、真实 CPU ONNX/IR 执行、ModelPack/ModelFactory 证据、测试、文档、打包及 clean consumer。详见[本版本说明](docs/releases/2.0.0-alpha.1.md)与[版本索引](docs/releases/README.md)。
