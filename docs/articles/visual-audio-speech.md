...
See [audio model acquisition](model-acquisition-audio-speech.md), [Stage 28 API changes](api-changes-stage28.md), and the [audio support matrix](../../eng/models/audio-speech/audio-speech-family-support.json). / 参阅[音频模型获取](model-acquisition-audio-speech.md)、[阶段 28 API 变更](api-changes-stage28.md)与[音频支持矩阵](../../eng/models/audio-speech/audio-speech-family-support.json)。
