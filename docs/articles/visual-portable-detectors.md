...
| Paddle decoded vector-count IR | Fixed-batch equivalents of the three Paddle inputs | `save_infer_model/scale_0.tmp_0:float32[300,6]`, `save_infer_model/scale_1.tmp_0:int32[1]` | Same decoded contract; output metadata is verified against OpenVINO Runtime 2026.2.1 | OpenVINO CPU |
